          ...
          {features.map((feature, idx) => (
            ...
            >
              ...
              <div className="group h-full p-2 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 shadow-[inset_0_2px_8px_rgba(0,0,0,0.04),inset_0_1px_2px_rgba(0,0,0,0.02)] transition-colors duration-300">
                ...
                <div className="h-full p-6 md:p-8 rounded-[2rem] bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border-t border-l border-r border-white/50 dark:border-white/10 border-b-[3px] border-b-slate-200/60 dark:border-b-slate-950 shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_20px_40px_-12px_rgba(20,184,166,0.2),0_10px_20px_-10px_rgba(50,50,93,0.1),inset_0_0_20px_rgba(255,255,255,0.5)] dark:group-hover:shadow-[0_20px_40px_-12px_rgba(20,184,166,0.15),inset_0_0_20px_rgba(255,255,255,0.05)] group-hover:border-teal-500/20 group-hover:border-b-teal-500 dark:group-hover:border-b-teal-400 active:translate-y-0 active:shadow-sm relative overflow-hidden">
